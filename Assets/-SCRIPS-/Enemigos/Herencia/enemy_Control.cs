...
public class enemy_Control : MonoBehaviour
{
    ...
    {   //si colisiona un objeto con el tag "PlayerDamage" su vida baja en funcion al daño del Jugador.
        ...
        {
            Instantiate(hitEffect,enemyPos.position, transform.rotation);//instancia un efecto cuando es golpeado.
            Instantiate(hit_Clip, enemyPos.position, transform.rotation);//instancia un efecto cuando es golpeado.
